...
const styles = StyleSheet.create({
  ...
  contadorNum: { fontFamily: 'DMSans_600SemiBold', fontSize: 28, color: cartasBosque.bosque },
  contadorDe: { fontFamily: 'DMSans_400Regular', fontSize: 18, color: cartasBosque.helecho },
  contadorLabel: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.helecho },
  extraBadge: {
    backgroundColor: cartasBosque.corteza, borderRadius: borderRadius.sm,
    paddingHorizontal: spacing[2], paddingVertical: 3,
  },
  extraBadgeText: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.bruma },
  seccionTitulo: {
  ...
  btnConfirmarText: { fontFamily: 'DMSans_600SemiBold', fontSize: 14, color: cartasBosque.bruma },
  reservaCard: {
    backgroundColor: cartasBosque.pergamino, borderRadius: borderRadius.md,
  ...
  reservaFecha: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.tinta },
  reservaExtra: {
    fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.corteza,
    marginTop: 3,
  },
