...
const styles = StyleSheet.create({
  ...
  contadorNum: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 28, color: cartasBosque.bosque },
  contadorDe: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 18, color: cartasBosque.helecho },
  contadorLabel: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.helecho },
  extraBadge: {
    backgroundColor: cartasBosque.alertaBorde, borderRadius: borderRadius.sm,
    paddingHorizontal: spacing[2], paddingVertical: 3,
  },
  extraBadgeText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.bruma },
  seccionTitulo: {
  ...
  reservaFecha: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 13, color: cartasBosque.tinta },
  reservaExtra: {
    fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.alertaBorde,
    marginTop: 3,
  },
