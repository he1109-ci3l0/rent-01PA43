...
const styles = StyleSheet.create({
  ...
  btnNuevaText: { fontFamily: 'DMSans_600SemiBold', fontSize: 12, color: cartasBosque.bruma },
  scrollContent: { padding: spacing[4] },
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: spacing[8], gap: spacing[2] },
  vacioText: { fontFamily: 'DMSans_600SemiBold', fontSize: 16, color: cartasBosque.tinta },
  vacioSub: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.helecho, textAlign: 'center' },
  secLabel: {
  ...
  emisorText: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.helecho, flex: 1 },
  ...
  mesChipText: { fontFamily: 'DMMono_400Regular', fontSize: 11, color: cartasBosque.tinta },
  mesChipTextActivo: { color: cartasBosque.bruma },
  anioRow: { flexDirection: 'row', alignItems: 'center', gap: spacing[3] },
  anioText: { fontFamily: 'DMSans_600SemiBold', fontSize: 16, color: cartasBosque.tinta },
  errorText: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.corteza, marginTop: spacing[2] },
  btnPrimario: {
  ...
  exitoTitulo: { fontFamily: 'DMSans_600SemiBold', fontSize: 20, color: cartasBosque.tinta },
  exitoSub: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.helecho, textAlign: 'center' },
  // Cards
  card: {
  ...
  cardConcepto: { fontFamily: 'DMSans_600SemiBold', fontSize: 14, color: cartasBosque.tinta, flex: 1 },
  ...
  cardPeriodo: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.helecho },
  cardRfc: { fontFamily: 'DMMono_400Regular', fontSize: 11, color: cartasBosque.tinta, marginTop: 2 },
  cardFecha: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.niebla, marginTop: spacing[1] },
  downloadRow: { flexDirection: 'row', alignItems: 'center', gap: spacing[1], marginTop: spacing[2] },
  downloadText: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.bosque },
  notasText: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.corteza, marginTop: spacing[1] },
});
