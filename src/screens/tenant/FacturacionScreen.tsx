...
const styles = StyleSheet.create({
  ...
  btnNuevaText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: cartasBosque.bruma },
  ...
  emisorText: { fontFamily: 'SpaceMono_400Regular', fontSize: 10, color: cartasBosque.helecho, flex: 1 },
  ...
  exitoTitulo: { fontFamily: 'Inter_600SemiBold', fontSize: 20, color: cartasBosque.tinta },
  exitoSub: { fontFamily: 'Inter_400Regular', fontSize: 13, color: cartasBosque.helecho, textAlign: 'center' },
  // Cards
  card: {
  ...
  cardConcepto: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: cartasBosque.tinta, flex: 1 },
  ...
  cardPeriodo: { fontFamily: 'Inter_400Regular', fontSize: 12, color: cartasBosque.helecho },
  cardRfc: { fontFamily: 'SpaceMono_400Regular', fontSize: 11, color: cartasBosque.tinta, marginTop: 2 },
