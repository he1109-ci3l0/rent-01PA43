...
const s = StyleSheet.create({
  ...
  headerHola: {
    fontFamily: 'BricolageGrotesque_700Bold', fontSize: 24, color: cartasBosque.bruma,
  ...
  headerMonto: {
    fontFamily: 'BricolageGrotesque_700Bold', fontSize: 30, color: cartasBosque.bruma,
    letterSpacing: -0.5, lineHeight: 34,
  },
  headerVenceVal: {
    fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 18, color: cartasBosque.bruma, lineHeight: 34,
  },
  ...
  headerInfoText: {
    fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.niebla, letterSpacing: 0.5,
  },
  ...
  alertaText: {
    flex: 1, fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, lineHeight: 17,
  },
  ...
  btnPrincipalText: {
    fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 15, color: cartasBosque.bruma, letterSpacing: 0.1,
  },
  ...
  btnDepositoText: {
    fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: '#CDB29D',
  ...
  cardAccion: {
    fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 13, color: cartasBosque.bosque,
  },
  cardRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap' },
  cardVal: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 13, color: cartasBosque.tinta },
  cardDivider: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 13, color: cartasBosque.pergaminoOscuro },
  boldVal:  { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 13, color: cartasBosque.tinta },
  alertVal: { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 13, color: '#960018' },
  okVal:    { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 13, color: '#4A5E48' },
  ...
  visitaNombre: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 13, color: cartasBosque.tinta },
  visitaMeta:   { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho },
  btnSalida: {
    paddingHorizontal: spacing[2], paddingVertical: spacing[1] + 1,
    borderRadius: borderRadius.sm, borderWidth: 1,
    borderColor: cartasBosque.pergaminoOscuro,
  },
  btnSalidaText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.tinta },
  btnNuevaVisita: {
  ...
  gridTitulo: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 14, color: cartasBosque.tinta },
  gridSub:    { fontFamily: 'MonaSans_400Regular',  fontSize: 10, color: cartasBosque.helecho, lineHeight: 13 },
  ...
  actividadVacioText: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.helecho },
  actividadRow: {
    flexDirection: 'row', alignItems: 'center', gap: spacing[3],
  ...
  actividadTexto: {
    flex: 1, fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.tinta,
  },
  actividadFecha: {
    fontFamily: 'MonaSans_400Regular', fontSize: 9, color: cartasBosque.niebla,
  },
