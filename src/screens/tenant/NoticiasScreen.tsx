...
const st = StyleSheet.create({
  ...
  seccionSub: {
    fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.niebla, marginTop: 2,
  },
  ...
  bannerTag: {
    fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.musgo,
    letterSpacing: 0.4, marginBottom: spacing[1],
  },
  bannerTitulo: {
    fontFamily: 'DMSans_600SemiBold', fontSize: 14, color: cartasBosque.tinta, marginBottom: 2,
  },
  bannerContenido: {
    fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.helecho, lineHeight: 17,
  },
  bannerFecha: {
    fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.niebla, marginTop: spacing[2],
  },
  ...
  chatHora: { fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.niebla },
  ...
  verTodosText: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.bosque },
  ...
  contactoInicial: {
    fontFamily: 'DMSans_700Bold', fontSize: 20, color: cartasBosque.tinta,
  },
  contactoNombre: {
    fontFamily: 'DMSans_600SemiBold', fontSize: 11, color: cartasBosque.tinta, textAlign: 'center',
  },
  contactoHab: {
    fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.helecho, textAlign: 'center',
  },
  ...
  nuevoBtnText: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.bosque },
  ...
  modalTag: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.musgo, letterSpacing: 0.5 },
  modalScroll: { padding: spacing[5], paddingBottom: spacing[10] },
  modalTitulo: {
    fontFamily: 'DMSans_700Bold', fontSize: 22, color: cartasBosque.tinta,
    marginBottom: spacing[1], letterSpacing: -0.2,
  },
  modalFecha: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.niebla, marginBottom: spacing[4] },
  modalImg: { width: '100%', height: 200, borderRadius: borderRadius.md, marginBottom: spacing[4] },
  modalContenido: { fontFamily: 'DMSans_400Regular', fontSize: 15, color: cartasBosque.tinta, lineHeight: 23 },
  ...
  // Reporte acoso modal
  reporteModal: { flex: 1 },
  reporteLabel: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.helecho },
  reporteInput: {
    backgroundColor: cartasBosque.pergamino, borderRadius: borderRadius.md,
    borderWidth: 1, borderColor: cartasBosque.pergaminoOscuro,
    padding: spacing[4], fontFamily: 'DMSans_400Regular', fontSize: 14, color: cartasBosque.tinta,
    minHeight: 140,
  },
  reporteEnviarBtn: {
