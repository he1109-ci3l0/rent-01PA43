...
const styles = StyleSheet.create({
  ...
  cardNombre: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: cartasBosque.tinta, flex: 1 },
  ...
  cardConcepto: { fontFamily: 'Inter_400Regular', fontSize: 13, color: cartasBosque.tinta },
  cardRfc: { fontFamily: 'SpaceMono_400Regular', fontSize: 11, color: cartasBosque.helecho, marginTop: 2 },
  cardFecha: { fontFamily: 'SpaceMono_400Regular', fontSize: 10, color: cartasBosque.niebla, marginTop: 2 },
  ...
  pdfText: { fontFamily: 'Inter_400Regular', fontSize: 11, color: cartasBosque.bosque },
...
const panelStyles = StyleSheet.create({
  ...
  valor: { fontFamily: 'Inter_400Regular', fontSize: 13, color: cartasBosque.tinta },
  input: {
