...
const styles = StyleSheet.create({
  ...
  segTextActivo: { color: cartasBosque.bosque, fontFamily: 'DMMono_400Regular' },
  ...
  reservaInfo: { flex: 1 },
  reservaHora: { fontFamily: 'DMMono_400Regular', fontSize: 16, color: cartasBosque.tinta },
  reservaNombre: { fontFamily: 'DMSans_400Regular', fontSize: 12, color: cartasBosque.helecho, marginTop: 2 },
  extraTag: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.corteza, marginTop: 2 },
  estadoBadge: { borderRadius: borderRadius.sm, paddingHorizontal: spacing[2], paddingVertical: 2 },
  estadoText: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.bruma },
  ...
  btnAuthText: { fontFamily: 'DMSans_600SemiBold', fontSize: 11, color: cartasBosque.bruma },
  btnCompletar: { backgroundColor: cartasBosque.helecho },
  btnCompletarText: { fontFamily: 'DMSans_600SemiBold', fontSize: 11, color: cartasBosque.bruma },
  btnCancelar: { borderWidth: 1, borderColor: cartasBosque.niebla, backgroundColor: 'transparent' },
  btnCancelarText: { fontFamily: 'DMSans_400Regular', fontSize: 11, color: cartasBosque.helecho },
  // Mes
  ...
  mesNavTitulo:  { fontFamily: 'DMSans_600SemiBold', fontSize: 15, color: cartasBosque.tinta },
  mesContainer:  { },
  mesDiasRow:    { flexDirection: 'row', marginBottom: spacing[1] },
  mesDiaHeader:  { flex: 1, textAlign: 'center', fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.helecho, textTransform: 'uppercase' },
  ...
  mesDiaNum:     { fontFamily: 'DMSans_500Medium', fontSize: 12, color: cartasBosque.tinta },
  mesDiaNumHoy:  { color: cartasBosque.bosque, fontFamily: 'DMSans_700Bold' },
  mesDots:       { flexDirection: 'row', flexWrap: 'wrap', gap: 2, marginTop: 2, justifyContent: 'center' },
  mesDot:        { width: 6, height: 6, borderRadius: 3 },
  mesMore:       { fontFamily: 'DMMono_400Regular', fontSize: 8, color: cartasBosque.helecho },
  // Semana
  ...
  semanaDia: { fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.helecho },
  semanaDiaHoy: { color: cartasBosque.bosque },
  semanaNum: { fontFamily: 'DMSans_600SemiBold', fontSize: 13, color: cartasBosque.tinta, marginVertical: 2 },
