...
const styles = StyleSheet.create({
  ...
  segText: { fontFamily: 'MonaSans_400Regular', fontSize: 11, color: cartasBosque.helecho },
  segTextActivo: { color: cartasBosque.bosque, fontFamily: 'MonaSans_400Regular' },
  ...
  reservaInfo: { flex: 1 },
  reservaHora: { fontFamily: 'MonaSans_400Regular', fontSize: 16, color: cartasBosque.tinta },
  reservaNombre: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.helecho, marginTop: 2 },
  extraTag: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.alertaBorde, marginTop: 2 },
  estadoBadge: { borderRadius: borderRadius.sm, paddingHorizontal: spacing[2], paddingVertical: 2 },
  estadoText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.bruma },
  ...
  btnAuthText: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 11, color: cartasBosque.bruma },
  btnCompletar: { backgroundColor: cartasBosque.helecho },
  btnCompletarText: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 11, color: cartasBosque.bruma },
  btnCancelar: { borderWidth: 1, borderColor: cartasBosque.niebla, backgroundColor: 'transparent' },
  btnCancelarText: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 11, color: cartasBosque.helecho },
  // Mes
  ...
  mesNavTitulo:  { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 15, color: cartasBosque.tinta },
  mesContainer:  { },
  mesDiasRow:    { flexDirection: 'row', marginBottom: spacing[1] },
  mesDiaHeader:  { flex: 1, textAlign: 'center', fontFamily: 'MonaSans_400Regular', fontSize: 9, color: cartasBosque.helecho, textTransform: 'uppercase' },
  ...
  mesDiaNum:     { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.tinta },
  mesDiaNumHoy:  { color: cartasBosque.bosque, fontFamily: 'BricolageGrotesque_700Bold' },
  mesDots:       { flexDirection: 'row', flexWrap: 'wrap', gap: 2, marginTop: 2, justifyContent: 'center' },
  mesDot:        { width: 6, height: 6, borderRadius: 3 },
  mesMore:       { fontFamily: 'MonaSans_400Regular', fontSize: 8, color: cartasBosque.helecho },
  // Semana
  ...
  semanaDia: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: cartasBosque.helecho },
  semanaDiaHoy: { color: cartasBosque.bosque },
  semanaNum: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 13, color: cartasBosque.tinta, marginVertical: 2 },
