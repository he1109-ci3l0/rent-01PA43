  ...
  return (
    <SafeAreaView style={s.safe} edges={[]}>
      ...
      {cargando ? (
        ...
        <View style={s.center}>
          <Ionicons name="bed-outline" size={40} color={cartasBosque.helecho} />
...
const s = StyleSheet.create({
  ...
  seccionTitulo: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho, letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: spacing[2], marginTop: spacing[3] },
  ...
  cardTipo:    { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 13, color: cartasBosque.tinta },
  cardDesc:    { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 11, color: cartasBosque.helecho, marginTop: 1 },
  estadoBadge: { paddingHorizontal: spacing[2], paddingVertical: 2, borderRadius: borderRadius.sm },
  estadoText:  { fontFamily: 'MonaSans_400Regular', fontSize: 9 },
  precio:      { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho },
  cardBody:    { padding: spacing[3], paddingTop: 0, borderTopWidth: 1, borderTopColor: cartasBosque.pergaminoOscuro, gap: spacing[2] },
  bodyLabel:   { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho, letterSpacing: 0.5 },
  bodyValor:   { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 13, color: cartasBosque.tinta },
  ...
  btnLiberarText: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.alertaBorde },
  ...
  btnAsignarText: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 13, color: cartasBosque.bruma },
  btnMantenimiento: { flexDirection: 'row', alignItems: 'center', gap: 4, alignSelf: 'flex-start' },
  btnMantenimientoText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.acento, textDecorationLine: 'underline' },
  ...
  inqChipText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.tinta },
  inqChipTextActivo: { color: cartasBosque.bruma },
  fieldLabel:  { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho, letterSpacing: 0.5, marginTop: spacing[3], marginBottom: spacing[1] },
  input:       { backgroundColor: cartasBosque.pergamino, borderRadius: borderRadius.sm, borderWidth: 1, borderColor: cartasBosque.pergaminoOscuro, paddingHorizontal: spacing[3], paddingVertical: spacing[2] + 2, fontFamily: 'BricolageGrotesque_400Regular', fontSize: 14, color: cartasBosque.tinta },
  ...
  empresaNote: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: cartasBosque.helecho, marginTop: spacing[2] },
