...
const styles = StyleSheet.create({
  ...
  buscadorInput: { flex: 1, fontFamily: 'DMSans_400Regular', fontSize: 14, color: cartasBosque.tinta },
  ...
  chatAdminNombre:   { flex: 1, fontFamily: 'DMSans_600SemiBold', fontSize: 16, color: cartasBosque.tinta },
  ...
  sheetSub:       { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.helecho, marginBottom: spacing[4] },
  ...
  apelacionSolicitante: { fontFamily: 'DMSans_600SemiBold', fontSize: 14, color: cartasBosque.tinta },
  apelacionMotivo: { fontFamily: 'DMSans_400Regular', fontSize: 13, color: cartasBosque.helecho, marginTop: spacing[1], marginBottom: spacing[2] },
  apelacionFecha: { fontFamily: 'DMMono_400Regular', fontSize: 9, color: cartasBosque.niebla, marginBottom: spacing[3] },
  ...
  apelacionBtnText: { fontFamily: 'DMMono_400Regular', fontSize: 10, color: cartasBosque.tinta },
