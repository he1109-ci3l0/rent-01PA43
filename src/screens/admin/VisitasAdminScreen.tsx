...
const s = StyleSheet.create({
  ...
  seedBtnText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho },
  statsRow: {
  ...
  statValor: { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 20 },
  statLabel: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: cartasBosque.helecho, marginTop: 1, textAlign: 'center' },
  tabBar: {
  ...
  tabBtnText: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho },
  tabBtnTextActivo: { color: cartasBosque.bosque },
  vacio: {
    fontFamily: 'BricolageGrotesque_400Regular', fontSize: 14, color: cartasBosque.helecho,
...
const fa = StyleSheet.create({
  ...
  nombre: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 13, color: cartasBosque.tinta, flexShrink: 1 },
  recurrente: { fontFamily: 'MonaSans_400Regular', fontSize: 8, color: '#960018', letterSpacing: 0.5 },
  ...
  estadoText: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: '#FFFFFF' },
  horasText: { fontFamily: 'MonaSans_400Regular', fontSize: 10 },
  progressBg: {
...
const fh = StyleSheet.create({
  ...
  duracion: { fontFamily: 'MonaSans_400Regular', fontSize: 12 },
  activaBadge: {
    backgroundColor: '#4A9B6F', borderRadius: borderRadius.full,
    paddingHorizontal: spacing[2], paddingVertical: 1,
  },
  activaText: { fontFamily: 'MonaSans_400Regular', fontSize: 8, color: '#FFFFFF' },
  rec: { fontFamily: 'MonaSans_400Regular', fontSize: 8, color: '#960018' },
});
...
const an = StyleSheet.create({
  ...
  metricVal: { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 22, color: cartasBosque.tinta },
  metricLabel: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: cartasBosque.helecho, marginTop: 2 },
  secTitle: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 12, color: cartasBosque.tinta, marginBottom: spacing[2] },
  vacio: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 13, color: cartasBosque.helecho, marginBottom: spacing[2] },
  row: {
  ...
  badgeText: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: '#FFFFFF' },
  countText: { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 16, color: '#960018' },
});
...
const pd = StyleSheet.create({
  ...
  panelNombre: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 17, color: cartasBosque.tinta },
  panelSub: { fontFamily: 'MonaSans_400Regular', fontSize: 11, color: cartasBosque.helecho, marginTop: 2 },
  cerrarBtn: {
  ...
  horasNum: { fontFamily: 'BricolageGrotesque_700Bold', fontSize: 32 },
  horasLabel: { fontFamily: 'MonaSans_400Regular', fontSize: 11, color: cartasBosque.helecho, marginTop: 4 },
  timelineRow: { flexDirection: 'row', alignItems: 'flex-start' },
  tlNode: { alignItems: 'center', width: 42 },
  tlDot: { width: 12, height: 12, borderRadius: 6 },
  tlLabel: { fontFamily: 'MonaSans_400Regular', fontSize: 8, textAlign: 'center', marginTop: 3 },
  ...
  seccionTitle: {
    fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 12, color: cartasBosque.tinta, marginBottom: spacing[2],
  },
  histRow: {
  ...
  histFecha: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.helecho },
  histDur: { fontFamily: 'MonaSans_400Regular', fontSize: 10, color: cartasBosque.tinta },
  ...
  rutaBtnText: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 12 },
  rutaElegida: {
