...
const styles = StyleSheet.create({
  ...
  mesTitulo: { fontFamily: 'BricolageGrotesque_600SemiBold', fontSize: 15, color: cartasBosque.tinta },
  ...
  celdaNum: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 13, color: cartasBosque.tinta },
  celdaNumPasado: { color: cartasBosque.niebla },
  celdaNumSelec: { color: cartasBosque.bruma, fontFamily: 'BricolageGrotesque_600SemiBold' },
  // Slots
  ...
  slotsVacio: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.niebla },
