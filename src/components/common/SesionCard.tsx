...
const styles = StyleSheet.create({
  ...
  actualText: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: '#4A5E48' },
  roboBadge: {
    paddingHorizontal: spacing[2], paddingVertical: 2,
    backgroundColor: 'rgba(103,0,16,0.15)', borderRadius: borderRadius.full,
  },
  roboText: { fontFamily: 'MonaSans_400Regular', fontSize: 9, color: '#960018' },
  ubicacion: { fontFamily: 'BricolageGrotesque_400Regular', fontSize: 12, color: cartasBosque.tinta },
